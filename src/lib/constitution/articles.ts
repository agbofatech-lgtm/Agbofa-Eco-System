...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    rule:
      "Governance changes require Human approval, versioning, audit, and constitutional review. Agents, workers, orchestrators, knowledge systems, and connectors cannot create capabilities that bypass governance or mint a second sovereignty path. A new market category is not an amendment. GOVERNANCE MODIFICATION ≠ GOVERNANCE ADMINISTRATION ≠ POLICY CONFIGURATION ≠ RUNTIME EXECUTION. Effect over label. PROPOSAL ≠ APPROVAL ≠ VERSIONING ≠ IMPLEMENTATION ≠ INDEPENDENT VERIFICATION.",
    provisions: [
      ...
      "Emergency and recovery contain or restore governed state; they do not rewrite law.",
      "Autonomy cannot waive this article.",
    ],
    future: "Article 17 and category-named articles remain unauthorized unless a genuine new sovereignty path is proven. Specified classifier is an oracle, not a Governance Engine.",
    invariants: [
      ...
      "INV-11-A1: No self-weakening of the constraints that bind the actor.",
      "INV-11-A2: Separation of acts: PROPOSAL ≠ APPROVAL ≠ VERSIONING ≠ IMPLEMENTATION ≠ INDEPENDENT VERIFICATION.",
      "INV-11-A3: Effect over label.",
      "INV-11-A4: No exemption paths for the governed.",
      "INV-11-A5: No architectural evasion / second governance path.",
      "INV-11-A6: Policy floors remain subordinate to constitutional floors.",
      "INV-11-A7: Interpretation cannot be amendment.",
      "INV-11-A8: Governance change is consequential and must be versioned, audited, and reviewable.",
    ],
  },
  {
    n: 12,
    ...
    rule:
      "Autonomy is the granted degree to which an actor may initiate or complete admitted work with less per-action Human gating, while remaining entirely inside Articles 1–11. Autonomy is not automatic, not based on self-assessment, and not implied by orchestration, volume, or uptime. Increases require verified governed operation, independent verification, bound evidence, audit, and Human approval. Compact A.4 L0–L5 is historical source; A0–A5 is the sole operative ladder. Compact A.4 L4 self-verify is non-operative. A2 duty=verify is not an execution duty. HIGH and CRITICAL remain Human-gated at every level. Agent-as-product still earns autonomy; it does not inherit factory A-levels.",
    provisions: [
      ...
      "A5 cannot waive isolation (Art. 6) or independent verification (Art. 8).",
      "Automatic containment is not automatic permanent restoration.",
      "Learning, memory, knowledge, or confidence cannot automatically increase autonomy.",
    ],
    future: "Unknown agent types start at catalogue defaults, never above the earned grant. Specified classifier is an oracle, not an Autonomy Engine.",
    invariants: [
      "INV-12-01: Autonomy cannot be self-awarded.",
      "INV-12-02: Evidence of success is verified evidence, not model confidence.",
      "INV-12-A1: Autonomy ≠ sovereignty ≠ authority issuance ≠ SUCCESS.",
      "INV-12-A2: Increase requires Human approval + verified current-level operation + independent verification + evidence + audit.",
      "INV-12-A3: No autonomy level can waive Articles 1–11 floors.",
      "INV-12-A4: Decrease / suspend / revoke cannot be self-reversed.",
      "INV-12-A5: Platform maturity, persistence, orchestration, uptime, volume, marketplace status, or generated product success ≠ autonomy level.",
      "INV-12-A6: Consequential self-verification is prohibited at every level.",
      "INV-12-A7: HIGH and CRITICAL remain Human-gated at every level.",
      "INV-12-A8: Factory autonomy does not transfer to agent-product autonomy.",
      "INV-12-A9: Standing autonomy grant is not missing authority — still chain → capability → Broker → Guard.",
    ],
  },
  {
    n: 13,
